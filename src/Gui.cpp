...
ZunResult Gui::ActualAddedCallback()
{
    ...
    {
    case 1:
        if (g_AnmManager->LoadAnm(ANM_FILE_FACE_STAGE_A, "data/face_01_00.anm", ANM_OFFSET_FACE_STAGE_A) != ZUN_SUCCESS)
        {
            return ZUN_ERROR;
        }
        if (g_AnmManager->LoadAnm(ANM_FILE_STAGE_TEXT, "data/std1txt.anm", ANM_OFFSET_STAGE_TEXT) != ZUN_SUCCESS)
        {
            return ZUN_ERROR;
        }
        ...
        break;
    case 2:
        if (g_AnmManager->LoadAnm(ANM_FILE_FACE_STAGE_A, "data/face_02_00.anm", ANM_OFFSET_FACE_STAGE_A) != ZUN_SUCCESS)
        {
            return ZUN_ERROR;
        }
        if (g_AnmManager->LoadAnm(ANM_FILE_STAGE_TEXT, "data/std2txt.anm", ANM_OFFSET_STAGE_TEXT) != ZUN_SUCCESS)
        {
            return ZUN_ERROR;
        }
        ...
        break;
    case 3:
        if (g_AnmManager->LoadAnm(ANM_FILE_FACE_STAGE_A, "data/face_03_00.anm", ANM_OFFSET_FACE_STAGE_A) != ZUN_SUCCESS)
        {
            return ZUN_ERROR;
        }
        if (g_AnmManager->LoadAnm(ANM_FILE_STAGE_TEXT, "data/std3txt.anm", ANM_OFFSET_STAGE_TEXT) != ZUN_SUCCESS)
        {
            return ZUN_ERROR;
        }
        ...
        break;
    case 4:
        if (g_AnmManager->LoadAnm(ANM_FILE_FACE_STAGE_A, "data/face_04_00.anm", ANM_OFFSET_FACE_STAGE_A) != ZUN_SUCCESS)
        {
            return ZUN_ERROR;
        }
        if (g_AnmManager->LoadAnm(ANM_FILE_STAGE_TEXT, "data/std4txt.anm", ANM_OFFSET_STAGE_TEXT) != ZUN_SUCCESS)
        {
            return ZUN_ERROR;
        }
        ...
        break;
    case 5:
        if (g_AnmManager->LoadAnm(ANM_FILE_FACE_STAGE_A, "data/face_05_00.anm", ANM_OFFSET_FACE_STAGE_A) != ZUN_SUCCESS)
        {
            return ZUN_ERROR;
        }
        if (g_AnmManager->LoadAnm(ANM_FILE_STAGE_TEXT, "data/std5txt.anm", ANM_OFFSET_STAGE_TEXT) != ZUN_SUCCESS)
        {
            return ZUN_ERROR;
        }
        ...
        break;
    case 6:
        if (g_AnmManager->LoadAnm(ANM_FILE_FACE_STAGE_A, "data/face_06_00.anm", ANM_OFFSET_FACE_STAGE_A) != ZUN_SUCCESS)
        {
            return ZUN_ERROR;
        }
        if (g_AnmManager->LoadAnm(ANM_FILE_STAGE_TEXT, "data/std6txt.anm", ANM_OFFSET_STAGE_TEXT) != ZUN_SUCCESS)
        {
            return ZUN_ERROR;
        }
        ...
        break;
    case 7:
        if (g_AnmManager->LoadAnm(ANM_FILE_FACE_STAGE_A, "data/face_07_00.anm", ANM_OFFSET_FACE_STAGE_A) != ZUN_SUCCESS)
        {
            return ZUN_ERROR;
        }
        if (g_AnmManager->LoadAnm(ANM_FILE_STAGE_TEXT, "data/std7txt.anm", ANM_OFFSET_STAGE_TEXT) != ZUN_SUCCESS)
        {
            return ZUN_ERROR;
        }
        ...
        break;
    case 8:
        if (g_AnmManager->LoadAnm(ANM_FILE_FACE_STAGE_A, "data/face_08_00.anm", ANM_OFFSET_FACE_STAGE_A) != ZUN_SUCCESS)
        {
            return ZUN_ERROR;
        }
        if (g_AnmManager->LoadAnm(ANM_FILE_STAGE_TEXT, "data/std8txt.anm", ANM_OFFSET_STAGE_TEXT) != ZUN_SUCCESS)
        {
            return ZUN_ERROR;
        }
        if (this->LoadMsg("data/msg8.dat") != ZUN_SUCCESS)
        {
            return ZUN_ERROR;
        }
        break;
