...
ZunResult MainMenu::BeginStartup()
{
    ...
    if (g_Supervisor.startupTimeBeforeMenuMusic > 0)
    {
        ...
        g_Supervisor.PlayAudio("bgm/th07_01.mid");
    }
    ...
    case STATE_REPLAY_LOAD:
        if (this->stateTimer == 60)
        {
            ...
            else
            {
                ...
                {
                    sprintf(replayFilePath, "./replay/th7_%.2d.rpy", cur + 1);
                ...
                _mkdir("./replay");
                _chdir("./replay");
                replayFileHandle = FindFirstFileA("th7_ud????.rpy", &replayFileInfo);
    ...
    if (this->stateTimer >= 32)
    {
        if (WAS_PRESSED_WEIRD(TH_BUTTON_LEFT))
        {
            ...
            case CURSOR_OPTIONS_POS_MUSICMODE:
                ...
                g_Supervisor.SetupMidiPlayback("bgm/th07_01.mid");
                g_Supervisor.PlayAudio("bgm/th07_01.mid");
                break;
