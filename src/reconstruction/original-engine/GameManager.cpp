...
DIFFABLE_STATIC_ARRAY_ASSIGN(char *, 10, g_EclFiles) = {"dummy",
                                                       "data/ecldata1.ecl",
                                                       "data/ecldata2.ecl",
                                                       "data/ecldata3.ecl",
                                                       "data/ecldata4.ecl",
...
DIFFABLE_STATIC_ARRAY_ASSIGN(AnmStageFiles, 9, g_AnmStageFiles) = {
    {"dummy", "dummy"},
...
DIFFABLE_STATIC_ARRAY_ASSIGN(DifficultyInfo, 6, g_DifficultyInfoForReplay) = {
...
DIFFABLE_STATIC_ARRAY_ASSIGN(DifficultyInfo, 6, g_DifficultyInfo) = {
    // rank, minRank, maxRank
    /* EASY    */ {16, 12, 20},
    /* NORMAL  */ {16, 10, 32},
    /* HARD    */ {16, 10, 32},
