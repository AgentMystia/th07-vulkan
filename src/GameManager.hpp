...
#define PSCR_NUM_CHARS_SHOTTYPES 6
#define PSCR_NUM_STAGES 8
#define PSCR_NUM_DIFFICULTIES 4

#define CLRD_NUM_CHARACTERS 6

#define CATK_NUM_CAPTURES 141
...
// TODO(th07): replace this TH06 layout assert after the full TH07 GameManager struct is mapped.
}; // namespace th07
